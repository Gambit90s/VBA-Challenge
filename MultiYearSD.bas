...
Sub Stock_RunThrough()
 ...
 'some data and formatting done with research through google, stackoverflow,study group and tutoring
    ...
    'Set up Greatest% Incerease, Decrease and Total Volume
